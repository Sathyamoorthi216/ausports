...
class EventListScreen extends StatelessWidget {
  final List<Event> events = [
    Event(
      ...
      date: 'November 18',
      imageAssetPath: 'lib/event/event4.jpeg',
    ),
    Event(
      title: 'CTF projects',
      description: 'long tearm and short tearm projects',
      date: '2023-11-27',
      imageAssetPath: 'lib/event/event5.jpeg',
    ),
    Event(
      title: 'VYUHAA 23',
      description: 'events and karnivals',
      date: 'october 14',
      imageAssetPath: 'lib/event/event1.jpeg',
    ),
    Event(
      title: 'VYUHAA 23',
      description: 'x hall EEE department',
      date: 'october 14',
      imageAssetPath: 'lib/event/event3.jpeg',
    ),
    Event(
      title: 'ALUMINI MEET 23',
      description: 'Ramanujam hall',
      date: 'october 15',
      imageAssetPath: 'lib/event/event2.jpeg',
    ),
  ];
